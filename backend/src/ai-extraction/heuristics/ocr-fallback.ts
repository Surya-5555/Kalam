...
export function mergeRecoveredInvoice(
  ...
  return {
    supplier: {
      ...
      gstin: mergeString(primary.supplier.gstin, fallback.supplier.gstin),
      pan: mergeString(primary.supplier.pan, fallback.supplier.pan),
    ...
    buyer: {
      ...
      gstin: mergeString(primary.buyer.gstin, fallback.buyer.gstin),
      pan: mergeString(primary.buyer.pan, fallback.buyer.pan),
    ...
    invoice: {
      ...
      placeOfSupply: mergeString(primary.invoice.placeOfSupply, fallback.invoice.placeOfSupply),
      notes: mergeString(primary.invoice.notes, fallback.invoice.notes),
      bankName: mergeString(primary.invoice.bankName, fallback.invoice.bankName),
      bankAccountNumber: mergeString(primary.invoice.bankAccountNumber, fallback.invoice.bankAccountNumber),
      bankIfsc: mergeString(primary.invoice.bankIfsc, fallback.invoice.bankIfsc),
      bankBranch: mergeString(primary.invoice.bankBranch, fallback.invoice.bankBranch),
